...
# 
# # STEP TWO
# ## install the Mac OSX version of pdftk (used for splitting, joining, compressing and overlaying pdf pages) from http://www.pdfhacks.com/pdftk/
# 
# # STEP THREE
# ## install pdf-API2 (a perl resource for handling pdfs and fonts) from http://search.cpan.org/~areibens/PDF-API2-0.55/lib/PDF/API2.pm
# 
# # STEP FOUR
# ## unzip the SectorMaker archive from http://micki001.cnc.net/trav/SectorMakerScripts.zip and place all the files in the computer's cgi folder. Also, create the output folder.
...
# 
# ## To use the script from a web browser, use the following URL syntax (you must already have turned on 'Web Sharing', using the 'Sharing' Preference Pane of 'System Preferences'):
...
pdftk /tmp/$1piecetemp.pdf cat 38-end output /tmp/$1piecetempText.pdf
wait
...
pdftk /tmp/$1piecetempIntro.pdf background /Library/WebServer/CGI-Executables/trav/Desc_Background.pdf output /tmp/$1pieceDescIntroWithBack.pdf
wait
...
pdftk /Library/WebServer/CGI-Executables/trav/backgrounds/SectorMap_Background.pdf background /tmp/$1_sectormap1.pdf output /tmp/$1_sectormap2.pdf compress
wait
...
pdftk /tmp/$1seccover1.pdf background /Library/WebServer/CGI-Executables/trav/SectorData_Cover.pdf output /tmp/$1CoverInt.pdf
wait
...
# Make the generated text of the back cover a pdf
pstopdf /tmp/$1CoverBack.ps -o /tmp/$1BackCovertemp.pdf

# Combine the generated text and the background back cover pdf into the new sector back cover.
pdftk /tmp/$1BackCovertemp.pdf background /tmp/$1CoverInt.pdf output /tmp/$1Cover.pdf
wait
...
subsec2 S=$x < /tmp/$1secdata > /tmp/$1subsec1$x
...
pdftk /tmp/$1subsecdatainter$x.pdf background /Library/WebServer/CGI-Executables/trav/backgrounds/Data_Background$x.pdf output /tmp/$1subsecdata$x.pdf
wait

# Extract the proper subsector borders page
pdftk /tmp/$1_subsectorborders.pdf cat $whichborderpage output /tmp/$1subsecborders$x.pdf
wait

# Combine the borders and the previous pdf
pdftk /tmp/$1subsecinter$x.pdf background /tmp/$1subsecborders$x.pdf output /tmp/$1subsecinter2$x.pdf
wait

# Place the generated map on a background with header and page number
pdftk /Library/WebServer/CGI-Executables/trav/backgrounds/Map_Background$x.pdf background /tmp/$1subsecinter2$x.pdf output /tmp/$1subsec$x.pdf
wait
...
# Make the generated text of the back cover a pdf
pstopdf /tmp/$1_SectorMapSectorTitle.ps -o /tmp/$1_SectorMapSectorTitle.pdf

#place the map on a Classic Traveller background
pdftk /tmp/$1_SectorMapSectorTitle.pdf background /tmp/$1_sectormap2.pdf output /tmp/$1_sectormap.pdf
wait
...
# turn to pdf
pstopdf /tmp/$1_politiespageout.ps -o /tmp/$1_politiespage1.pdf
wait

# join with background (header, page nums)
pdftk /tmp/$1_politiespage1.pdf background /Library/WebServer/CGI-Executables/trav/backgrounds/SectorPolities_Background.pdf output /tmp/$1_politiespage.pdf
wait
...
pdftk /tmp/$1pre.pdf /tmp/$1_sectormap.pdf /tmp/$1_politiespage.pdf cat output /tmp/$1.pdf compress
wait
...
pdftk /tmp/$1Cover.pdf /Library/WebServer/CGI-Executables/trav/SectorData_IntDesc.pdf /tmp/$1subsecdataA.pdf /tmp/$1subsecA.pdf /tmp/$1subsecdataB.pdf /tmp/$1subsecB.pdf /tmp/$1subsecdataC.pdf /tmp/$1subsecC.pdf /tmp/$1subsecdataD.pdf /tmp/$1subsecD.pdf /tmp/$1subsecdataE.pdf /tmp/$1subsecE.pdf /tmp/$1subsecdataF.pdf /tmp/$1subsecF.pdf /tmp/$1subsecdataG.pdf /tmp/$1subsecG.pdf /tmp/$1subsecdataH.pdf /tmp/$1subsecH.pdf /tmp/$1subsecdataI.pdf /tmp/$1subsecI.pdf /tmp/$1subsecdataJ.pdf /tmp/$1subsecJ.pdf /tmp/$1subsecdataK.pdf /tmp/$1subsecK.pdf /tmp/$1subsecdataL.pdf /tmp/$1subsecL.pdf /tmp/$1subsecdataM.pdf /tmp/$1subsecM.pdf /tmp/$1subsecdataN.pdf /tmp/$1subsecN.pdf /tmp/$1subsecdataO.pdf /tmp/$1subsecO.pdf /tmp/$1subsecdataP.pdf /tmp/$1subsecP.pdf cat output /tmp/$1pre.pdf
wait
...
pdftk /tmp/$1pre.pdf /tmp/$1_sectormap.pdf /tmp/$1_politiespage.pdf /tmp/$1secdatadescpiece.pdf cat output /tmp/$1.pdf compress
wait
...
#pdftk /tmp/$1.pdf cat 2-end output /tmp/$1nocover.pdf
